          ...
          {/* Display contact info here */}
            <div>
              ...
              <div className="flex justify-center space-x-4 mb-4">
                ...
                <a href="mailto:contact@ahmedballal.com" className="text-white transition-all duration-300 ease-in-out hover:border-b hover:border-zinc-500 hover:text-green-400 hover:brightness-125"
                >
                  Email
                </a>
